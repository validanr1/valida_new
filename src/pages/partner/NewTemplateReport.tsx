...
const NewTemplateReport = () => {
  ...
  const [sections, setSections] = useState<ReportSection[]>([
    { key: "escopo", title: "Escopo do Trabalho", body: "Este <span style='color: #2563eb; font-weight: 600;'>relatório de fatores de riscos psicossociais relacionados ao trabalho</span> integra as ações de avaliação das condições laborais dos colaboradores, com ênfase na identificação e análise técnica dos <span style='color: #2563eb; font-weight: 600;'>fatores de riscos psicossociais presentes no ambiente de trabalho</span>. Seu objetivo é contribuir para a promoção da saúde mental, bem-estar e produtividade dos trabalhadores, bem como para o cumprimento da legislação vigente.\n\nO <span style='color: #2563eb; font-weight: 600;'>relatório de riscos psicossociais relacionados ao trabalho em conformidade com as diretrizes da NR-01</span>, atualizada pela <span style='color: #2563eb; font-weight: 600;'>Portaria MTE nº 1.419/2024</span> e vigente a partir de maio de 2026, que passou a integrar de forma formal os fatores psicossociais ao Gerenciamento de Riscos Ocupacionais (GRO). Também atende à <span style='color: #2563eb; font-weight: 600;'>NR-17</span>, ao <span style='color: #2563eb; font-weight: 600;'>Guia de Informações sobre Fatores Psicossociais Relacionados ao Trabalho (MTE)</span>, às recomendações da <span style='color: #2563eb; font-weight: 600;'>HSE-SIT (Health and Safety Executive)</span> e à <span style='color: #2563eb; font-weight: 600;'>norma internacional ISO 45003</span>, assegurando alinhamento com as melhores práticas nacionais e internacionais em Saúde e Segurança do Trabalho.\n\nAlém de atender aos requisitos legais, este relatório oferece subsídios técnicos fundamentados para decisões estratégicas no âmbito do <span style='color: #2563eb; font-weight: 600;'>Programa de Gerenciamento de Riscos (PGR)</span>, como:\n\n• Aprofundamento das análises por meio de <span style='color: #2563eb; font-weight: 600;'>Análise Ergonômica do Trabalho (AEP/AET)</span>, quando aplicável;\n• Priorização de medidas de prevenção e controle;\n• Definição de planos de ação alinhados ao PGR voltados à construção de ambientes de trabalho mais saudáveis, seguros e produtivos." },
